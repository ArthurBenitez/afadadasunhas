...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "A fada das Unhas — Cursos, Beleza e Cuidado" },
      ...
      { name: "author", content: "A fada das Unhas" },
      { property: "og:title", content: "A fada das Unhas — Cursos, Beleza e Cuidado" },
      ...
      { property: "og:site_name", content: "A fada das Unhas" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "A fada das Unhas — Cursos, Beleza e Cuidado" },
