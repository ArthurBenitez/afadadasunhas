...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Afada das Unhas — Beleza, Cuidado e Cursos" },
      { name: "description", content: "Estúdio premium de unhas em São Paulo. Agende seu horário ou inscreva-se nos cursos exclusivos." },
      { name: "author", content: "Afada das Unhas" },
      { property: "og:title", content: "Afada das Unhas" },
      { property: "og:description", content: "Beleza, cuidado e cursos para suas unhas." },
